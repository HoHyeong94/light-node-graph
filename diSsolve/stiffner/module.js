...
export function HstiffGen(point1, point2, webPoints1, webPoints2, hstiffLayout){
...
export function hBracingFrame(point1, point2, webPoints, hBSection, sectionDB) {
