...
export function UflangePoint(girderPoint, pointDict, girderBaseInfo, slabInfo, slabLayout) {
    ...
    let tr0 = { x: rw2.x + ps.uFlangeC + w1 + hl3 * 3 , y: rw2.y + hh + girderPoint.gradientY * ( ps.uFlangeC + w1) };
    ...
    let tr3 = { x: rw2.x + ps.uFlangeC - ps.uFlangeW - w1 - hl4*3, y: rw2.y + hh + girderPoint.gradientY * (ps.uFlangeC - ps.uFlangeW - w1) };
