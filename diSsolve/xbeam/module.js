...
export function DYXbeam2(iPoint, jPoint, iSectionPoint, jSectionPoint, xbeamSection) {
  ...
  for (let i = 0; i < 4; i++) {
    ...
    let lowerbracket1 = [{ x: 0, y: xs.bracketWidth / 2 }, { x: sign * 15, y: xs.bracketWidth / 2 }, { x: sign * 43, y: xs.flangeWidth / 2 - 81 }, { x: sign * bracketLength, y: xs.flangeWidth / 2 },
    { x: sign * bracketLength, y: -xs.flangeWidth / 2 }, { x: sign * 43, y: -xs.flangeWidth / 2 + 81 }, { x: sign * 15, y: -xs.bracketWidth / 2 }, { x: 0, y: -xs.bracketWidth / 2 }];
