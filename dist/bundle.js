(function (global) {
  ...
  function hBracingSection(point1, point2, webPoints, hBSection, sectionDB) {
    ...
    result['frame1'] = hPlateGen(frame1, centerPoint, Math.abs(pts[4]),z1,90,0,0,null,true,null);
    result['frame2'] = hPlateGen(frame2, centerPoint, Math.abs(pts[5]),z2,90,0,0,null,true,null);
    return result 
  }
